									...
									<div class="panel-body bio-graph-info">
										...
										<form class="form-horizontal" role="form">
											<div class="form-group">
												<label class="col-lg-2 control-label">Sponsorship
													Name</label>
												<div class="col-lg-6">
													<input type="text" class="form-control"
														id="sponsorship_name" placeholder=" ">
												</div>
											</div>
													...
													<section class="panel">
														...
														<div class="table-responsive text-nowrap">
															<table id="myTable" class="table table-striped">
																...
																<tbody>
																	<c:forEach items="${sponsorshipList}"
																		varStatus="loopCount" var="sponsorshipList">
																		<tr>
																			<td>${loopCount.count}</td>
																			<td>${sponsorshipList.sponsorship_nature}</td>
											...
											<div class="form-group">
												<div class="col-lg-offset-2 col-lg-10">
													<button onclick="addSponsorship()" type="submit"
...
<script>
	...
	<script>
		function addSponsorship() {
			var sponsorship_nature = document
					.getElementById("sponsorship_name").value.toUpperCase();
